...
public class OutlineRectangle extends PaintCanvasBase implements IShapeInterface {
    ...
    public OutlineRectangle(ShapeConfiguration shapeConfig, int i, int j, int w, int h) {
    ...
    public void draw(Graphics g) {
        ...
        paint.drawRect(AX-5, AY-5, widths+10, heights+10);
    }
